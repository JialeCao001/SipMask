...
# ---------------------------------------------------------------------------- #
_C.MODEL.SIPMASK = CN()
_C.MODEL.SIPMASK.NUM_CLASSES = 81  # the number of classes including background
_C.MODEL.SIPMASK.FPN_STRIDES = [8, 16, 32, 64, 128]
_C.MODEL.SIPMASK.PRIOR_PROB = 0.01
_C.MODEL.SIPMASK.INFERENCE_TH = 0.05
_C.MODEL.SIPMASK.NMS_TH = 0.6
_C.MODEL.SIPMASK.PRE_NMS_TOP_N = 1000

# Focal loss parameter: alpha
_C.MODEL.SIPMASK.LOSS_ALPHA = 0.25
# Focal loss parameter: gamma
_C.MODEL.SIPMASK.LOSS_GAMMA = 2.0

# the number of convolutions used in the cls and bbox tower
_C.MODEL.SIPMASK.NUM_CONVS = 4

# if CENTER_SAMPLING_RADIUS <= 0, it will disable center sampling
_C.MODEL.SIPMASK.CENTER_SAMPLING_RADIUS = 0.0
# IOU_LOSS_TYPE can be "iou", "linear_iou" or "giou"
_C.MODEL.SIPMASK.IOU_LOSS_TYPE = "iou"

_C.MODEL.SIPMASK.NORM_REG_TARGETS = False
_C.MODEL.SIPMASK.CENTERNESS_ON_REG = False
_C.MODEL.SIPMASK.USE_DCN_IN_TOWER = False

...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("deform_psroi_pooling_backward", &deform_psroi_pooling_backward, "deform_psroi_pooling_backward");
   // crop split
  m.def("crop_split_forward", &crop_split_forward, "crop_split_forward");
  m.def("crop_split_backward", &crop_split_backward, "crop_split_backward");
  m.def("crop_split_gt_forward", &crop_split_gt_forward, "crop_split_gt_forward");
  m.def("crop_split_gt_backward", &crop_split_gt_backward, "crop_split_gt_backward");
}
